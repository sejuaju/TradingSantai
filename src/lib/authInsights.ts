...
export const LOGIN_INSIGHTS: AuthInsight[] = [
  ...
  },
  {
    ...
    body:
      ...
      "tergesa gesa ingin masuk posisi hari ini, pertimbangkan untuk tidak trading sama " +
    ...
    footnote: "Skala 1 sampai 10: seberapa tenang perasaanmu sekarang? Di bawah 6, istirahat dulu.",
  },
  {
    tag: "Disiplin",
    ...
    body:
      ...
      "Jika jawabannya belum, jangan tergesa gesa login ke chart. Rapikan dulu rencanamu. " +
